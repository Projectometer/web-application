    ...
    <q-layout class="o-layout" view="hHh LpR fFf">
        <q-header class="row q-layout-header">
            <q-toolbar class="q-px-lg q-py-sm">
                ...
                <q-toolbar-title class="title"> Projectometer </q-toolbar-title>
                <q-space v-if="!isLoggedIn"></q-space>

                <div class="login-Style">
                    <q-tabs inline-label v-if="!isLoggedIn">
                        <q-route-tab
                            class="col btn btn-small noselect"
                            name="Login"
                            icon="fingerprint"
                            @click="signIn"
                        />
...
const signIn = async function () {
    try {
        const redirectUrl = await AuthModule.getAuthUrl();
...
<style>
.icon-rotate-90 .q-icon {
    transform: rotate(90deg);
}
.icon-rotate-135 .q-icon {
