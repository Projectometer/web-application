            ...
            <q-card-section>
                ...
                <div class="tune-card-selection-style">
                    <q-toggle
                        ...
                        :model-value="modelValue.showMonthLabel"
                        @update:model-value="
                            (e) => updateData(e, 'showMonthLabel')
                        "
...
import { CalendarView, LocalesItem, CalenderOptionsData } from 'src/types';
import { ref } from 'vue';
...
const emit = defineEmits(['update:model-value', 'onSaveSetting', 'onCancel']);
